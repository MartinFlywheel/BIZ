...
export function ClientMetricsForm({ clientId, metric, onClose }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/60 py-8">
            <div className="w-full max-w-2xl rounded-xl border border-white/[0.08] bg-zinc-900 p-6">
